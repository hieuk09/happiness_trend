...
class ResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create response" do
    assert_difference('Response.count') do
      post responses_url, params: { response: { answer: @response.answer, question: @response.question } }
    end
  ...
  test "should update response" do
    patch response_url(@response), params: { response: { answer: @response.answer, question: @response.question } }
